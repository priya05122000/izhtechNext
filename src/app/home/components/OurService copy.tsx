            ...
            <div className="lg:px-10  bg-[#F7F9FA] rounded">
                ...
                <div className="relative py-10">
                    ...
                    <div className="w-full lg:pl-10">
                        ...
                        <div className="flex flex-col ring-transparent align-start md:flex-col  lg:flex-row gap-2 md:gap-4 lg:gap-2 sm:justify-center md:justify-start">

                            <div className="flex lg:flex-col overflow-x-auto lg:min-w-55 scrollbar-hide">
