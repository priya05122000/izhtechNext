                        ...
                        >
                            ...
                            <div className="relative w-full mb-6">
                                ...
                                <input
                                    ...
                                    className="w-full border-0 border-b-2 border-gray-400 focus:border-black focus:ring-0 outline-none pl-0 py-2 text-sm font-medium"
                                />
                            ...
                            <div className="bg-[#A5B7FF1F] border border-[#00000012] rounded-sm shadow-sm">
                                ...
                                <ul className="space-y-0 text-sm">
                                    ...
                                    <li
                                        className={`px-4 py-2.5 border-b-2 border-[#e5e7eb] cursor-pointer ${!selectedCategory
                                    ...
                                    {categories.map((cat, i) => (
                                        ...
                                        <li
                                            key={i}
                                            className={`px-4 py-2.5 border-b-2 border-[#e5e7eb] last:border-b-0 cursor-pointer ${selectedCategory === cat
                                                ? "bg-blue-100 ] font-bold"
                                                : ""
                                                }`}
                                            onClick={() =>
