...
const Banner = () => {
    return (
            ...
            <div className="flex gap-5 py-3 px-0 sm:px-10 mx-auto ">
                <div className="relative gap-10 mx-auto lg:flex">
                    <div
                        ...
                        //     amount: 0.15,
                        // }}
                        className="relative bg-transparent lg:w-1/2 hero-fade-right"
                    >
        ...
        "
                        ...
                        />
                        <Image
                            src="/images/about/bannernew.webp"
         ...
         35vw"
                    ...
                    <div
                        ...
                        //     amount: 0.15,
                        // }}
                        className="flex-col justify-center gap-10 lg:gap-5 xl:gap-10 md:pe-0 mt-5 lg:mt-0 lg:pe-10 lg:w-1/2 lg:flex hero-fade-left"
                    >
                        <div>
